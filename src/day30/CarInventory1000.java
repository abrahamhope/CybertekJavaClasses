...
//
//        for ( String eachCar: cars) {
//            if(eachCar.startsWith("Honda")||eachCar.startsWith("Toyota")){
//                String [] eachCarSplitting= eachCar.split("-");
//                System.out.println("Car make is "+eachCarSplitting[0]+
//                        " Car Model is "+ eachCarSplitting[1]);
//            }
//        }
        System.out.println("------- car model with only 2 characters");
        int count=0;
        for (String eachCar: cars) {
